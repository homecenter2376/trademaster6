...
- Custom Themes: Including the new Midnight Professional theme with optimized dark mode colors and UI elements

## Theme System

The application includes a comprehensive theme system with the following features:

### Available Themes
- Light Theme: Classic light mode with high contrast
- Dark Theme: Standard dark mode for reduced eye strain
- Midnight Professional: A sophisticated dark theme optimized for professional use
  - Carefully selected color palette based on deep blues and purples
  - High contrast ratios for better readability
  - Professional accent colors for UI elements
  - Consistent shadows and borders
  - Custom scrollbar styling
  - Optimized code block colors
...
- UI element colors (borders, cards, popups)
- Chat-specific colors (bubbles, hover states)
