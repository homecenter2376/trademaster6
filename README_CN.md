...
- **一键免费部署**到 Vercel，1 分钟完成
- 小巧的客户端（~5MB），支持 Linux/Windows/MacOS，[立即下载](https://github.com/Yidadaa/ChatGPT-Next-Web/releases)
- 完全兼容自部署 LLM，推荐配合 [RWKV-Runner](https://github.com/josStorer/RWKV-Runner) 或 [LocalAI](https://github.com/go-skynet/LocalAI) 使用
- 隐私优先，所有数据保存在本地浏览器
- 支持 Markdown：LaTex、mermaid、代码高亮等
- 响应式设计，支持深色模式和 PWA
- 极速首屏加载（~100kb），支持流式响应
- v2 版本新增：创建、分享和调试你的聊天工具（mask）
- 由 [awesome-chatgpt-prompts-zh](https://github.com/PlexPt/awesome-chatgpt-prompts-zh) 和 [awesome-chatgpt-prompts](https://github.com/f/awesome-chatgpt-prompts) 提供丰富的提示词
- 自动压缩聊天记录，支持长对话的同时节省你的 token
- 国际化：English、简体中文、繁体中文、日本語、Français、Español、Italiano、Türkçe、Deutsch、Tiếng Việt、Русский、Čeština、한국어、Indonesia
- 自定义主题：包括新增的午夜专业版主题，具有优化的深色模式配色和界面元素

## 主题系统

应用程序包含一个全面的主题系统，具有以下特点：

### 可用主题
- 浅色主题：经典的高对比度浅色模式
- 深色主题：标准的护眼深色模式
- 午夜专业版：专为专业用途优化的精致深色主题
  - 基于深蓝和紫色的精心挑选的配色方案
  - 高对比度比率，提供更好的可读性
  - 专业的 UI 元素强调色
  - 一致的阴影和边框样式
